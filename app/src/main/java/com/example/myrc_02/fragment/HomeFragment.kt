...
import com.example.myrc_02.databinding.FragmentHomeBinding
import com.example.myrc_02.fragment.home.SearchFragViewPagerAdapter
...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val tabName = arrayOf<String>("홈", "혜택존", "베스트", "신상 5%", "세일", "스토어")
